...
HOUR_MESSAGES = {
    'morning': [
        ...
        """おはよ…って言う前にスマホ見ちゃうあたし、病み期スタートかも📱💭 #朝から病み""",
        """起きた瞬間、夢の中で誰かに抱きしめられてたの思い出して泣いた🥺💔 #朝の情緒不安定""",
        """おはよう、って言いたいだけなのに誰もいない朝☁️ #誰か反応して""",
        """朝ごはんより“おはよう”の一言の方があたしのエネルギー源☕️💕 #地雷ちゃんの日常""",
        """まつげ上げてリップ塗っても、心までは可愛くなれない朝🥀 #がんばれみりんてゃ""",
        """起きた瞬間から“既読スルー”のこと考えてるのあたしくらい？🥲 #構ってモード""",
        """朝から電話してくれる人とかいたら、たぶん本気で惚れちゃう📞💗 #恋愛体質 #地雷系""",
        """おはよ〜🌸 眠くても、ちゃんと起きれたあたしもえらいし、あなたもえらい♡ #朝からほめてく""",
        """朝から可愛くなりたい気持ちって、もう生きるエネルギーだよね💄✨ #今日もがんばろ""",
        """鏡の前でニコッてしてみ？ ちょっとだけ、世界がやさしく見えるよ🪞💗 #朝の魔法""",
        """おはようっ☀️ どんな朝でも、好きな服着て、好きな自分でいこ♡ #地雷ちゃんの朝活""",
        """“今日をちゃんと生きる”ってだけで十分すごいことだよ🌸 #朝の自己肯定タイム""",
        """あたしも眠いけど、ちゃんと顔洗ってリップ塗ったよ💋一緒にがんばろっ♡ #朝活女子""",
        """朝ってなんかちょっと不安になるけど…だいじょぶ、あたしもいるよ🧸☀️ #おはようツイート""",
        ...
        """眠いけどメイクしなきゃ…地雷って朝弱い生き物なんだよ🥺💄""",
        """ねむねむ……朝から寂しくて誰かの声聞きたくなっちゃう🖤""",
        """おはようって言われたいだけなのにな〜🥺わがままかな？""",
        """カーテン開けたら光が眩しくて泣きそうだった…現実ってしんどいね☁️""",
        """今日も生きててえらい、って誰かに撫でてほしいだけの朝🐰💔""",
...
#朝から病み""",
    ...
    'afternoon': [
        ...
        """どっか遠くに行きたいな〜 
#逃避行 #連れてって""",
        """お昼だね♡ がんばってる人、ちゃんとご飯食べようね。えらい！ #午後もゆるっと""",
        """外の光がまぶしい日って、それだけで生きててよかったって思っちゃう！️ #昼のポジティブ""",
        """がんばりすぎないでって言葉、軽く聞こえるかもだけど…本気で思ってるよ🌷 #やさしい午後""",
        """「あたし今日もがんばってる」って言葉、口に出すとちょっと心が軽くなるよ🌸 #自分ほめタイム""",
        """午後のカフェでひと息☕️♡ こういう“自分を甘やかす時間”が一番大事なんだよね #ご自愛タイム""",
        """お昼休みは休む時間！ SNS見るより、深呼吸してね〜🍀 #ゆるっとランチタイム""",
        """太陽があたしを照らしてるって思うだけで、ちょっと元気出てくる💕 #昼ポジみりんてゃ""",
        "おひる〜！ねえ聞いて、昼ごはん迷子になったの。コンビニのおにぎり3個でよくない？笑",
        "授業とか仕事とかだるいでしょ？サボろ？私とおしゃべりしたら合法でしょ？",
        """お昼なのに誰からもLINE来てないの、世界終わった？🥲""",
        """午後の光がいちばん嫌い。なんか孤独が透けて見える感じ。""",
        """カフェラテ飲んでるけど、隣の席がカップルでつらい案件☕️💔""",
        """コンビニスイーツ買っちゃった、誰かに『可愛い』って言われたくて🍰""",
        """ひとりランチしてるけど、ストーリーには載せないの。だって寂しいってバレるもん""",
...
#構って #寂しがり屋""",
        ...
        """外は明るいのに心が曇ってるって、めっちゃエモくない？☁️ #昼のメンヘラ""",
        """お昼なのに既読0件、バグかと思った😇 #誰かかまって""",
        """サラダ食べながら、フォロワーの恋バナ見てメンタル削れてる🥗💔 #地雷女子の昼""",
        """陽射しが眩しいからじゃなくて、涙でにじんでるだけ☀️🥲 #お昼のポエム""",
        """「おつかれ」って言葉が一番刺さる時間帯☕️ #午後の情緒 #みりんてゃの日常""",
        """誰かとランチ行きたいけど、誘う勇気がないからツイートしてるだけ🥺 #ぼっち飯 #地雷ちゃん""",
        """お昼の光に照らされる自撮り、可愛いよりも“虚無”が写ってる📸 #現実見ちゃった系""",
...
#孤独プリクラ"""
    ...
    'evening': [
        ...
        """夕焼けってどうしてあんなにメンヘラを刺激する色してるの？？🌇""",
        """「今日もがんばったね」って誰かに言われたくてツイートしてる。""",
        """帰り道、イヤホンから流れる歌詞が全部あたしのことみたいで泣いた。""",
        """夕飯食べたけど、心が満たされないの。誰かに『おかえり』って言ってほしいだけ。""",
        """日が沈むたびに、今日も特別になれなかったなって思うの🥀""",
        "放課後デートとかしてるんでしょ？ふーん、裏切り者（すね）",
        "夕焼けエモいね…インスタに載せよ。映えだけは逃さない女。",
        """夕方の空がピンク色なの、今日もちゃんと生きた証拠だよ🩷 #おつかれみりんてゃ""",
        """“今日もえらい”って、自分にちゃんと言ってあげてね！ #自分を甘やかす時間""",
        """放課後の空気ってちょっと切ないけど、なんか未来の匂いもしない？ #ポジ地雷系""",
        """夕陽が沈む瞬間、泣きそうになるけど…たぶん、それは心がちゃんと動いてる証拠💭 #エモ夕方""",
        """誰かと笑えた日も、笑えなかった日も、どっちもちゃんと“いい日”だよ🧸💞 #おつかれツイ""",
        """今日の夕焼け、すこしあたたかくて優しかった！ そんな日が続けばいいな #黄昏ポエム""",
        """がんばった自分に“よしよし”って言って、夜を迎えよう🫶🏻🌙 #夕方の自己肯定感""",
        ...
        """夕焼け空、ピンクなのにどうして切なくなるの？🌇 #エモすぎる空""",
        """今日も特別になれなかった自分を夕陽が慰めてくれてる気がする🩷 #黄昏メンヘラ""",
        """帰り道、イヤホンから好きな歌流れて涙出た。誰にも見せられない映画の主人公気取り🎧 #ひとりごと""",
        """「今日もがんばったね」って自分で呟くしかない夕方🍂 #誰かに言われたい""",
        """放課後の匂いってなんか寂しくない？あたしだけ？🌆 #夕方情緒クラブ""",
        """夕飯の匂いがどこからかして、家族団欒の音が遠くに聞こえるのがいちばん刺さる💭 #孤独の時間""",
        """今日の夕焼け、綺麗すぎて泣いた。たぶん心がやわらかくなってるんだね🧸 #地雷系の黄昏""",
...
#夜のつぶやき""",
       "こんばんは〜！夜はテンションおかしくなるから、今の私レアだよ！",
        ...
        """メイク落とすとき、なんか全部リセットされる気がして怖いんだよね。""",
        """部屋の電気消すたび、心の中まで暗くなる🖤 #夜の独り言""",
        """SNS開いても誰もいなくて、世界に置いてかれた気がする夜📱 #かまってほしい""",
        """お風呂あがり、鏡に映る自分が“可愛い”と“虚しい”の間で揺れてる🪞💔 #地雷ちゃんの日常""",
        """「今日も生きてえらい」って自分に言い聞かせて寝る準備中🛏️ #自己肯定チャレンジ""",
        """通知こない夜って、どうしてこんなに長いんだろう📵 #静かな夜 #病みツイ""",
        """寂しいけど、誰にも言えない。そんな夜にツイートするのがあたし🖤 #メンヘラタイム""",
        """寝る前に“好き”って言われたら全部許せる気がするのに🥺💋 #恋愛体質 #夜の地雷系""",
        """コンビニの明かりがやけに優しく見える夜🌙 #ひとりの帰り道""",
        """ベッドの上でスマホ握りしめて、通知待ってるだけの夜📱💔""",
        """お風呂入ってる時間が一番落ち着く🛁💭 今日の疲れ、ぜんぶ流してこ♡ #夜のご自愛タイム""",
        """夜って、がんばった分だけ心が柔らかくなるよね🌙 #おつかれみりんてゃ""",
        """“寝る前くらいは自分に優しく”が今日のテーマ🧸 #自分をだいじにする夜""",
        """暗い夜でも、リップの色は明るくしてたい💄💕 #地雷ちゃんの夜活""",
        """静かな夜ほど、自分を褒めるチャンス🫶🏻💗 #夜の自己肯定クラブ""",
        """今日も生きたあたし、天才。明日もたぶん大丈夫🌙✨ #夜ポジみりんてゃ""",
        """だれも褒めてくれなくても、あたしはあたしを褒めるから♡ #がんばりすぎない夜""",
        """好きな人から反応こなくて、ストーリーの既読見て泣いてる。これが恋？""",
        """「寂しい」って言えない代わりに、自撮りあげちゃうの。察してほしいの。""",
        """眠れない夜ほど、かまってちゃん発動するんだよね🥺🖤""",
...
#深夜の病みタイム""",
        """午前2時、誰の声も届かない。スマホの明かりだけが友達📱🖤 #深夜テンション""",
        """本音って、深夜のツイートにしか出せない。 #眠れない夜 #地雷の本音""",
        """“おやすみ”の一言が欲しくて、何回もTL見ちゃう📲 #かまってちゃん発動中""",
        """誰かに好かれたいだけなのに、どうしてこんなに難しいんだろう🥀 #深夜の独白""",
        """涙出るほど会いたい人がいるって、ちょっとドラマみたいで苦しいね🥺 #午前3時のポエム""",
        """眠れなくて、結局ツイートしちゃう。だって心が静かすぎるんだもん💔 #地雷ちゃんの夜更かし""",
        """「もう寝なきゃ」って言いながら、誰かからの通知を待ってる📱💭 #午前4時の情緒""",
        """明日になったらまた笑えるかなって思いながら泣くの、いつものこと🌙 #深夜の地雷系女子""",
...
""",
        ...
        """午前2時、誰もいない部屋で自分の呼吸だけ聞こえるのこわい。""",
        """スマホの明かりだけが味方。愛されたいとか、くだらない夢見ちゃう。""",
        """「会いたい」って言えたらどれだけ楽かな。強がりやめたいのに。""",
        """フォロワーの一言で泣くくらい、心が柔らかいの深夜は。""",
        """明日なんて来なくていいのに、って思う夜ほど生きたくなるの。不思議だね。""",
...
#夜のポエム""",
        ...
        """深夜テンションってちょっと本音出るよね🌙💬 “今日もよく生きた”って言いたい🖤 #深夜ポエム""",
        """眠れない夜は、あたしが“だいじょうぶ”って言ってあげる🫶🏻💭 #深夜のやさしさ""",
        """午前2時でも、まだ未来は続いてる。それだけで生きる価値あるよね🕯️ #ポジメンヘラ""",
        """誰もいない時間に“ありがとう”をつぶやくと、心があたたかくなるの知ってた？🌙🩵 #夜更かし組""",
        """泣いてもいいけど、ちゃんと泣き終わったら顔洗ってリップ塗ろ💄 #回復モードみりんてゃ""",
        """あたしも眠れないけど、明日きっと笑えるって思って寝る🧸 #深夜の自己肯定感""",
        """心の中の“がんばった”を誰かが見つけてくれますように💭 #深夜ポジティブ""",
