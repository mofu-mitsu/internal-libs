...
# 🎯 いいね対象のハッシュタグとキーワード
TARGET_HASHTAGS = ['#地雷女', '#病みかわ','#可愛い','#かわいい','#メンヘラ','#猫','#ねこ','#量産系','#オリキャラ', '#推し', '#jirai', '#一次創作', '#オリジナル', '#イラスト','#推しキャラプロフィールメーカー']
TARGET_KEYWORDS = ['地雷', '量産', '病みかわ','可愛い','かわいい','メンヘラ','猫', 'ねこ','相性診断','オリキャラ', '推し', 'jirai', '一次創作', 'オリジナル', 'イラスト', 'プロフィールメーカー']
